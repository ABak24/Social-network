...
<div class="row">
        <div class="col-sm-12">
            <div class="main-content">
                <div class="header">
                <h3 style="text-align:center;"><strong>Login to social network.</strong></h3><hr>
                </div>
                <div class="l-part">
                    <form action="" method="post">
                        ...
                        <a style="text-decoration: none; float: right; color:#187FAB;" data-toogle="tooltip" title="Create Account!" 
                        href="signup.php">Don't have an account?</a><br><br>
                        <center><button id="signin" class="btn btn-info btn-lg"
